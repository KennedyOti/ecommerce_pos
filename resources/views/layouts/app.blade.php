...
<head>
    ...
    <title>Smart Business Solution</title>
    <!-- Fonts -->
...
<body>
    <div id="app">
        ...
        <div class="container-fluid mb-5">
                ...
                <div class="row border-top shadow-sm px-xl-5">
                    ...
                    <div class="col-lg-3 d-none d-lg-block">
                        <a class="btn shadow-none d-flex align-items-center justify-content-between bg-primary text-white w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; margin-top: -1px; padding: 0 30px">
                            ...
                            <i class="bi bi-angle-down text-dark"></i>
                        </a>
                                ...
                                <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                                    <div class="nav-item dropdown">
                                        <a href="#" class="nav-link" data-toggle="dropdown">Dresses
                                            <i class="bi bi-angle-down float-right mt-1"></i></a>
            ...
            <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
                <div class="row px-xl-5 pt-5">
                    <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                        ...
                        <p class="mb-2">
                            <i class="bi bi-map text-primary mr-3"></i>123 Street, New York, USA
                        </p>
                        <p class="mb-2">
                            <i class="bi bi-envelope text-primary mr-3"></i>info@example.com
                        </p>
                        <p class="mb-0">
                            <i class="bi bi-phone text-primary mr-3"></i>+012
                            345 67890
                        </p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-5">
                                ...
                                <div class="d-flex flex-column justify-content-start">
                                    <a class="text-dark mb-2" href="index.html"><i class="bi bi-angle-right mr-2"></i>Home</a>
                                    <a class="text-dark mb-2" href="shop.html"><i class="bi bi-angle-right mr-2"></i>Our
                                        Shop</a>
                                    <a class="text-dark mb-2" href="detail.html"><i class="bi bi-angle-right mr-2"></i>Shop
                                        Detail</a>
                                    <a class="text-dark mb-2" href="cart.html"><i class="bi bi-angle-right mr-2"></i>Shopping Cart</a>
                                    <a class="text-dark mb-2" href="checkout.html"><i class="bi bi-angle-right mr-2"></i>Checkout</a>
                                    <a class="text-dark" href="contact.html"><i class="bi bi-angle-right mr-2"></i>Contact Us</a>
                                </div>
                            </div>
                            <div class="col-md-4 mb-5">
                                <h5 class="font-weight-bold text-dark mb-4">
                ...
                <div class="row border-top border-light mx-xl-5 py-4">
                    <div class="col-md-6 px-xl-0">
                        <p class="mb-md-0 text-center text-md-left text-dark">
                            ...
                            <a class="text-dark font-weight-semi-bold" href="https://www.frajosantech.co.ke">Frajosan IT Consultancies Ltd</a>
                        </p>
                    </div>
            ...
            <!-- Back to Top -->
            <a href="#" class="btn btn-primary back-to-top"><i class="bi bi-angle-double-up"></i></a>
        </div>
